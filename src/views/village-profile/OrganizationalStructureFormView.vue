...
const form = reactive({
  ...
  title: orgStructureContent.value?.title ?? '',
  content: orgStructureContent.value?.content ?? '',
...
const photoPreview = ref(orgStructureContent.value?.thumbnail || null)
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-2">
              ...
              <Editor
                ...
                placeholder="Tulis pengantar atau keterangan struktur organisasi di sini"
              />
            </div>

            <div class="flex flex-col gap-2">
              <span class="text-[13px] font-semibold text-slate-700">
                Foto Struktur / Bagan (opsional)
              </span>
